...
VJDEP= ICollection.o List.o IDictionary.o OrderedDictionary.o Categoria.o Suscripcion.o dtSuscripcion.o dtVideoJuego.o Estadistica.o Desarrollador.o
...
Fabrica.o: Fabrica/Fabrica.cpp Controlador.o IControlador.o #1
	$(GXX) -c $^
...
Contratacion: Contratacion/Contratacion.cpp VideoJuego.o #6
	$(GXX) -c $^

VideoJuego.o: Videojuego/Videojuego.cpp $(VJDEP) #7
	$(GXX) -c $^
...
EnVivo: EnVivo/EnVivo.cpp Multijugador.o ICollection.o List.o Comentario.o #14
	$(GXX) -c $^
